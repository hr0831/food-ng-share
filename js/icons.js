...
const PATHS = {
  ...
  /* 好きなもの: ハート */
  like: `
    <path d="M12 20.3 4.2 12.6a4.9 4.9 0 0 1 0-7 4.9 4.9 0 0 1 7 0l.8.8.8-.8a4.9 4.9 0 0 1 7 0 4.9 4.9 0 0 1 0 7Z"/>
  `,
  /* ふたりとも好き: 重なったハート */
  bothLike: `
    <path d="M9.8 20.4 3.4 14a4.1 4.1 0 0 1 0-5.9 4.1 4.1 0 0 1 5.8 0l.6.6.6-.6a4.1 4.1 0 0 1 5.8 0 4.1 4.1 0 0 1 0 5.9Z"/>
    <path d="M15.3 6.1a4.1 4.1 0 0 1 5.3.4 4.1 4.1 0 0 1 0 5.9l-2.3 2.3"/>
  `,
  /* 食材: 葉 */
  ingredient: `
